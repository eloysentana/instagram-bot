...
class Browser:
    def __init__(self, window: bool = True, binary_location: Optional[str] = None, default_lang: bool = False, **kwargs):
        ...
        # Chromedriver is fetched automatically for whatever platform this runs on,
        # instead of relying on a binary bundled per-OS in the repo.
...
class Tab:
    ...
    def new_tab(self, url: str = 'https://www.google.com'):
        ...
        Args:
            - url : to navigate after opening tab
